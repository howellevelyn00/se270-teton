...
class TestSmokeTest():
    ...
    def test_test(self):
      self.driver.get("https://howellevelyn00.github.io/se270-teton/")
      ...
      self.driver.find_element(By.NAME, "fname").send_keys("Evelyn")
      self.driver.find_element(By.NAME, "lname").click()
      self.driver.find_element(By.NAME, "lname").send_keys("Howell")
      ...
      self.driver.find_element(By.ID, "username").send_keys("Evelyn")
      self.driver.find_element(By.ID, "password").click()
      self.driver.find_element(By.ID, "password").send_keys("EvelynIsMe")
